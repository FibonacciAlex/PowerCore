...
/**
 * KGame浣跨敤鐨凷tringWriter锛岄潪绾跨▼瀹夊叏锛屼粎渚汮SON浣跨敤锛岃�铏戝埌{@link JSONObject#toString()}骞朵笉闇�
 * 绾跨▼瀹夊叏锛屾墍浠ュ氨鏀圭敤杩欎釜KStringWriter鑰岄潪JSONObject浣跨敤鐨凷tringWriter
 * 
 * @author PERRY CHAN
 */
public class KStringWriter extends Writer{
	 ...
	 */
	public KStringWriter(int initialSize) {
		if (initialSize < 0) {
	 ...
	 * @since 1.5
	 */
	public KStringWriter append(CharSequence csq) {
		if (csq == null)
			write("null");
		else
			write(csq.toString());
	 ...
	 * @since 1.5
	 */
	public KStringWriter append(CharSequence csq, int start, int end) {
	 ...
	 * @since 1.5
	 */
	public KStringWriter append(char c) {
		write(c);
		return this;
	}
